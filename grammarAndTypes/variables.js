...
-let does NOT need to be defined let x;
-const does need to be defined const y = 2;
*/
...
3.Assinment operator
4.The initial value
*/

//The declaration is to the left of the assignment operator (=)
//This is where the variable is created, by utilizing a designated JavaScript keyword and giving it a name
